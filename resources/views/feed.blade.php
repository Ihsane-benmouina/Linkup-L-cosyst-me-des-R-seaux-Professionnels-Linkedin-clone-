                                    ...
                                    <div>
                                        <div class="flex items-center gap-2 flex-wrap">
                                            ...
                                            @if(auth()->id() !== $post->user_id)
                                                <form action="{{ route('users.follow', $post->user) }}" method="POST" class="m-0 inline">
                                                    @csrf
                                                    @if(auth()->user()->isFollowing($post->user))
                                                        <button type="submit" class="text-[9px] bg-purple-100 text-purple-800 border border-purple-300 px-2 py-0.5 rounded-full font-bold transition hover:bg-rose-100 hover:text-rose-700 hover:border-rose-300 cursor-pointer">
                                            ...
                                            @else
                                                <span class="text-[9px] bg-slate-100 text-slate-500 px-1.5 py-0.5 rounded font-bold uppercase tracking-wider">Vous</span>
                                            @endif
                                        </div>
